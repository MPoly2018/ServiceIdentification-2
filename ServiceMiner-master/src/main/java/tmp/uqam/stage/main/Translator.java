...
public class Translator {
    ...
    public static void main(String[] args) {
    	...
    	System.out.println("_____________________+++++++++" + args[1]);
        if (args.length != 2) {
        ...
        //KDMMetaModelParser parser = new KDMMetaModelParser("/Users/manel/Documents/Phd/Comparison_tools/ServiceIdentification_copie/project/src/main/resources/base_kdm.xmi", "base", false);
        KDMMetaModelParser parser = new KDMMetaModelParser(args[1], args[2], false);
